...
const ChangeResultsPage: React.FC = () => {
    ...
    const handleSave = () => {
        setSuccessMessage('Results updated successfully!');
        ...
        <div>
            ...
            <Card>
                <form onSubmit={handleSearch}>
                    <CardHeader title="Change Results" subtitle="Search for a class's results to modify them." />
                    <CardBody>
            ...
            {showResults && (
                <Card className="mt-8">
                    <CardHeader title="Editing Results for Grade 9A - Mathematics" />
                    <CardBody>
...
export default ChangeResultsPage;

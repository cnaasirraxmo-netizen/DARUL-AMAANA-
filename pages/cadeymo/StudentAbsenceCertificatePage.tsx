...
const StudentAbsenceCertificatePage: React.FC = () => {
        ...
        <div>
            <Card>
                <form onSubmit={handleSubmit}>
                    <CardHeader title="Student Absence Report" subtitle="Generate an official report for a student's absences." />
                    <CardBody>
                    ...
                    <CardBody>
                        ...
                        <div className="p-8 border rounded-lg bg-white printable-area">
                            <div className="text-center mb-8">
                                ...
                                <h3 className="text-xl font-semibold mt-6 border-b-2 pb-2 inline-block">Warqadda Maqnaanshaha Ardayga</h3>
                            </div>
                            <div className="text-lg space-y-4">
                                <p><span className="font-semibold">To Whom It May Concern,</span></p>
                                <p>This letter details the attendance record for the following student:</p>
                                <p><span className="font-semibold">Name:</span> Ahmed Ali</p>
                                <p><span className="font-semibold">Class:</span> Grade 7A</p>
                                <p><span className="font-semibold">Period:</span> 2024-10-01 to 2024-10-31</p>
                                <p className="font-semibold mt-4">Record of Absences:</p>
                                <ul className="list-disc list-inside pl-4">
                                    <li><span className="font-semibold">2024-10-15:</span> Absent (Sick, parent notified)</li>
                                    <li><span className="font-semibold">2024-10-16:</span> Absent (Sick, parent notified)</li>
                                </ul>
                                <p className="mt-6">This information is accurate according to our official attendance logs.</p>
                            </div>
...
export default StudentAbsenceCertificatePage;

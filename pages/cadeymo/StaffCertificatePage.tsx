        ...
        <div>
            <Card>
                <form onSubmit={handleSubmit}>
                    <CardHeader title="Staff Certificate" subtitle="Generate a certificate of employment for a staff member." />
                    <CardBody>
                    ...
                    <CardBody>
                        ...
                        <div className="p-8 border rounded-lg bg-white printable-area">
                            <div className="text-center mb-8">
                                ...
                                <h3 className="text-xl font-semibold mt-6 border-b-2 pb-2 inline-block">Caddeynta Shaqaalaha</h3>
                            </div>
                            <div className="text-lg space-y-4">
                                <p><span className="font-semibold">To Whom It May Concern,</span></p>
                                <p>
                                    This is to certify that <span className="font-bold">Omar Hassan</span> is a valued member of our staff,
                                    serving in the capacity of <span className="font-bold">Mathematics Teacher</span> since <span className="font-bold">August 15, 2021</span>.
                                </p>
                                <p>
                                    Throughout their tenure at Mogadishu Primary & Secondary School, they have demonstrated
                                    professionalism and dedication to their role.
                                </p>
                                <p className="mt-6">This certificate is issued upon their request for official purposes.</p>
                            </div>

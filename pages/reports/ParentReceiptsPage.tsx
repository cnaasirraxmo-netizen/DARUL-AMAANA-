...
const mockPayments = [
    { id: 'P001', date: '2024-09-05', amount: 250, student: 'Ahmed Ali' },
    { id: 'P002', date: '2024-10-04', amount: 250, student: 'Ahmed Ali' },
];

const ParentReceiptsPage: React.FC = () => {
        ...
        <div>
            <Card>
                <form onSubmit={handleSubmit}>
                    <CardHeader title="Parent Receipts" subtitle="Find all payments made by a specific parent/guardian." />
                    <CardBody>
                        <div className="max-w-md">
                            <Input label="Search by Parent Name or Phone" id="parent-search" placeholder="Enter parent's details..." required />
                        </div>
                    </CardBody>
            ...
            {showHistory && (
                <Card className="mt-8">
                    <CardHeader title="Payment History for: Abdi Ali (Parent)" />
                    <CardBody>
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {mockPayments.map(p => (
                                        <tr key={p.id}>
                                            ...
                                            <td className="px-6 py-4 text-sm font-medium">{p.student}</td>
